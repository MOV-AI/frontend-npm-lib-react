  ...
  return (
    <AppBar position="static" color="inherit">
      <Toolbar data-testid="section_logs-filter-bar" variant="dense">
        ...
        <div
          className={`${classes.doubleFlexContainer} ${classes.displayFlex} ${classes.center}`}
        >
          {/* Search Input */}
          <SearchInput
        ...
        >
          <div
            className={`${classes.doubleFlexContainer} ${classes.displayFlex}`}
          >
            {/* Tags */}
            <TagsPopover
              tags={tags}
          ...
          <div
            className={`${classes.flexContainer} ${classes.displayFlex} ${classes.flexEnd}`}
          >
            {/* Settings */}
            <SettingsPopover
              advancedMode={advancedMode}
